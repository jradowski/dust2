...
const Home = () => {
  ...
  return (
    <main className="flex p-6 flex-col items-center">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5 rounded-tl-xl mb-10 bg-blue-300 dark:bg-gradient-to-r dark:from-gray-800 dark:to-gray-900 p-4 sm:p-6 rounded-xl shadow-lg text-justify text-base md:text-lg font-medium">
      ...
      <div className="w-3/4 grid grid-cols-1 mb-10 md:grid-cols-2 bg-blue-300 dark:bg-gradient-to-r dark:from-gray-800 dark:to-gray-900 p-4 sm:p-6 rounded-xl shadow-lg text-justify text-base md:text-lg font-medium">
      ...
      <div className="grid grid-cols-1 gap-10 bg-blue-300 dark:bg-gradient-to-r dark:from-gray-800 dark:to-gray-900 p-4 sm:p-6 rounded-xl shadow-lg text-justify text-base md:text-lg font-medium">
        <div>
