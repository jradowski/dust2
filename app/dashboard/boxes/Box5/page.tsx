...
const Home = async () => {
    ...
    return (
        <main className="flex flex-col items-center sm:text-sm ">
            ...
            <div
                className="content-center grid grid-cols-1 gap-20 bg-blue-300 dark:bg-gradient-to-r dark:from-gray-800 dark:to-gray-900 p-6 m-8 rounded-xl shadow-lg text-justify text-lg font-medium ">
                <div className="mt-2">
